...
test_inputs: list[tuple[Error, str]] = [
    ...
    (
        StateInheritanceError("a", "b", Some(0), Some(1)),
        "STATE ERROR: 'a' at 0:1 cannot inherit from 'b' because it is not defined",
    ),
    (
    ...
    (TypedefPathError("a.b.c"), "ERROR: Typedef path 'a.b.c' is not valid"),
    (
